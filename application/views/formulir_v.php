							  ...
							  <div class="form-actions">
									<div class="form-group">
										<div class="text-right mbl">
											<a href="<?php echo base_url(); ?>beranda/view_laporan" class="btn btn-green">&nbsp;
											Laporan Bulanan</a>
											<a href="<?php echo base_url(); ?>beranda/cari_data" class="btn btn-green">&nbsp;
											Cari Data</a>
							...
							<div class="col-lg-12">
                                <div class="portlet box">
                                    <div class="portlet-header">
                                        <div class="caption">
                                           Formulir Registrasi Nomor Surat</div>
                                    </div>
									<div class="portlet-body">
											<form action="<?php echo base_url(); ?>beranda/insert" id="formulir" method="post" class="form-horizontal">
